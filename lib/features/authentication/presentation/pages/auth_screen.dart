...
class AuthScreenState extends State<AuthScreen> with TickerProviderStateMixin {
              ...
              Column(
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    curve: Curves.linear,
                    child: goToSelectLoginMethod ? chooseLoginMethodLayer(context) : onboardingLayer(context),
                  ),
                ],
              ),
            ],
  ...
  Container chooseLoginMethodLayer(BuildContext context) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16),
      margin: EdgeInsets.only(bottom: MediaQuery.of(context).padding.bottom, top: 20),
      child: Column(
