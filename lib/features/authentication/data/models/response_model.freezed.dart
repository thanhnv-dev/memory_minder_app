...
class _$ResponseModelImpl implements _ResponseModel {
  const _$ResponseModelImpl(
      {this.data, required this.statusCode, required this.message});
  ...
  @override
  String toString() {
    return 'ResponseModel(data: $data, statusCode: $statusCode, message: $message)';
  }
...
abstract class _ResponseModel implements ResponseModel {
  const factory _ResponseModel(
      ...
      required final String message}) = _$ResponseModelImpl;
